...
read_fat_ok:
	...
	mov ax, 0400h			; Segment where we'll load the kernel
	mov es, ax
	mov bx, 0
...
load_file_sector:
	...
	mov ax, 0400h			; Set buffer past what we've already read
	mov es, ax
	mov bx, word [pointer]
...
next_cluster_cont:
	...
	jmp 0000h:4000h			; Jump to entry point of loaded kernel!
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "BOOT    SYS"	; MichalOS/2 Kernel

	disk_error	db "E00", 0
	file_not_found	db "E01", 0
	boot_complete	db "E02", 0
;	boot_fail		db "E03", 0
